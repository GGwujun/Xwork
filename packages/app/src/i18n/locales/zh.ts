...
export default {
  ...
  "skills.search_title": "技能搜索",
  "skills.search_skills_placeholder": "搜索 skills",
  "skills.search_tags_placeholder": "标签（逗号分隔）",
  "skills.search_button": "搜索",
  "skills.searching": "搜索中",
  "skills.stats_last_query": "上次查询",
  "skills.stats_last_refresh": "上次刷新",
  "skills.stats_total": "技能总数",
  "skills.search_results_title": "结果",
  "skills.search_empty": "暂无结果。",
  "skills.preview_title": "预览",
  "skills.preview_empty": "选择一个 skill 以预览。",
